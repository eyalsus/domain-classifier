...
def main():
    ...
    if args.input_pickle:
        ...
        word_statistics, states_set, words_in_domain_counter = \
        domain_to_word_features(list(input_df['base_domain']))
...
def create_random_domain_name(model, word_statistics, initial_state):
    ...
    while len(word_list) < 25 and len(word_statistics[current_state]['transitions']) > 0:
        ...
        prob_dict = convert_counter_to_probabilities(word_statistics[current_state]['sentence_length'])
